...
import com.example.ract9.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showResult() {
        try {
            ...
            binding.output.setTextColor(ContextCompat.getColor(this, R.color.empty))
        }
        catch (e:Exception){
